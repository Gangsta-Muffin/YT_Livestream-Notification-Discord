...
3.  Lastly, you will need to install the Youtube Api <a href="https://github.com/googleapis/google-api-python-client">library</a>. To do this, run the following command in your terminal: `pip install google-api-python-client`
